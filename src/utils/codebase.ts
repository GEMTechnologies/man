...
const ALLOWED_EXTENSIONS = [
  ...
  ".swift",
  // Edge cases
  // https://github.com/man-sh/man/issues/880
  ".py",
  // https://github.com/man-sh/man/issues/1221
  ".php",
];
...
//
// ex: https://github.com/man-sh/man/issues/727
...
async function formatFile({
  ...
  try {
    ...
    if (!shouldReadFileContents({ filePath, normalizedRelativePath })) {
      return `<man-file path="${normalizedRelativePath}">
