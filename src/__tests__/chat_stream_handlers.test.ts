...
describe("getmanAddDependencyTags", () => {
  it("should return an empty array when no dyad-add-dependency tags are found", () => {
    const result = getmanAddDependencyTags("No dyad-add-dependency tags here");
...
describe("getmanWriteTags", () => {
  it("should return an empty array when no dyad-write tags are found", () => {
    const result = getmanWriteTags("No dyad-write tags here");
    expect(result).toEqual([]);
  });

  it("should return a dyad-write tag", () => {
    const result =
      getmanWriteTags(`<dyad-write path="src/components/TodoItem.tsx" description="Creating a component for individual todo items">
...
describe("getmanRenameTags", () => {
  it("should return an empty array when no dyad-rename tags are found", () => {
    const result = getmanRenameTags("No dyad-rename tags here");
    expect(result).toEqual([]);
  });
...
describe("getmanDeleteTags", () => {
  it("should return an empty array when no dyad-delete tags are found", () => {
    const result = getmanDeleteTags("No dyad-delete tags here");
    expect(result).toEqual([]);
  });
