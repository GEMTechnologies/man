...
export const TURBO_EDITS_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    { type: "link", content: " Get man Pro", url: "https://man.sh/pro#ai" },
...
export const SMART_CONTEXT_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: "man Pro's Smart Context",
      url: "https://man.sh/pro#ai",
    },
  ],
};
...
export const REDDIT_TIP: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: "man subreddit",
      url: "https://www.reddit.com/r/manbuilders/",
    },
  ],
};
...
export const BUILD_A_BIBLE_APP_TIP: MessageConfig = {
  spans: [
    ...
    {
      type: "text",
      content: " the creator of man build a Bible app step-by-step",
    },
  ],
};
...
export const DEBUGGING_TIPS_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      ...
      url: "https://www.man.sh/docs/guides/debugging",
    },
  ],
};

// Advanced tip: Customize your AI rules https://www.man.sh/docs/guides/ai-rules
export const AI_RULES_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "AI rules",
      url: "https://www.man.sh/docs/guides/ai-rules",
    },
  ],
};
...
// Want to know what's next? Checkout our roadmap https://www.man.sh/docs/roadmap
export const ROADMAP_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "roadmap",
      url: "https://www.man.sh/docs/roadmap",
    },
  ],
};

// Like man? Star it on GitHub https://github.com/man-sh/man/
export const GITHUB_TIP: MessageConfig = {
  spans: [
    {
      type: "text",
      content: "Like man? Star it on ",
    },
    {
      type: "link",
      content: "GitHub",
      url: "https://github.com/man-sh/man",
    },
  ],
};
