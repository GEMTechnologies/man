...
export function ProBanner() {
  ...
  if (settings?.enableManPro || userBudget) {
    return null;
  }
    ...
    <div
      ...
      onClick={() => {
        IpcClient.getInstance().openExternalUrl(
          "https://www.man.sh/pro#ai?utm_source=man-app&utm_medium=app&utm_campaign=in-app-banner-ai-access",
        );
      }}
    >
      <div
      ...
      <div className="relative z-10 text-center flex flex-col items-center gap-0.5 sm:gap-1 md:gap-1.5 px-4 md:px-6 pr-6 md:pr-8">
        <div className="mt-0.5 sm:mt-1 flex items-center gap-2 sm:gap-3 justify-center">
          ...
          <button
            type="button"
            aria-label="Subscribe to man Pro"
...
export function SmartContextBanner() {
  return (
    <div
      ...
      onClick={() => {
        IpcClient.getInstance().openExternalUrl(
          "https://www.man.sh/pro#ai?utm_source=man-app&utm_medium=app&utm_campaign=in-app-banner-smart-context",
        );
      }}
    >
      <div
...
export function TurboBanner() {
  return (
    <div
      ...
      onClick={() => {
        IpcClient.getInstance().openExternalUrl(
          "https://www.man.sh/pro#ai?utm_source=man-app&utm_medium=app&utm_campaign=in-app-banner-turbo",
        );
      }}
    >
      <div
