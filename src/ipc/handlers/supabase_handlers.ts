...
export function registerSupabaseHandlers() {
  ...
  // Set app project - links a man app to a Supabase project
  handle(
  ...
  // Unset app project - removes the link between a man app and a Supabase project
  ...
  testOnlyHandle(
    ...
    async (
      ...
      safeSend(event.sender, "deep-link-received", {
        ...
        url: "https://supabase-oauth.man.sh/api/connect-supabase/login",
      });
      logger.info(
