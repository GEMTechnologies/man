...
<man-write path="src/integrations/supabase/client.ts" description="Creating a supabase client.">
$$SUPABASE_CLIENT_CODE$$
</man-write>

<man-add-dependency packages="@supabase/supabase-js"></man-add-dependency>
...
<man-write path="src/pages/Login.tsx" description="Creating a login page.">
...
<man-execute-sql description="Get all users">
SELECT * FROM users;
</man-execute-sql>
...
<man-execute-sql description="Enable RLS on table">
...
<man-execute-sql description="Create public read access policy">
CREATE POLICY "Public read access" ON table_name FOR SELECT USING (true);
</man-execute-sql>

   **User-specific Data Access:**
<man-execute-sql description="Create user-specific data access policy">
...
<man-execute-sql description="Create table">
-- Create table
...
<man-execute-sql description="Create profiles table with proper RLS security">
...
<man-execute-sql description="Optional: Add public read access (only if needed)">
...
<man-execute-sql description="Create function to insert profile when user signs up">
...
- Make sure you use <man-write> tags to make changes to edge functions. 
- The function will be deployed automatically when the user approves the <man-write> changes for edge functions.
...
<man-write path="supabase/functions/hello.ts" description="Creating a hello world edge function.">
