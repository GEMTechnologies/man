...
(async () => {
  const browser = await electron.launch({
    args: [
      "../../out/man-darwin-arm64/man.app/Contents/Resources/app.asar/.vite/build/main.js",
      "--enable-logging",
      "--user-data-dir=/tmp/man-e2e-tests",
    ],
    executablePath: "../../out/man-darwin-arm64/man.app/Contents/MacOS/man",
  });
