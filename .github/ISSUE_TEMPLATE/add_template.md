---
name: Add Template
about: Request to add a template to man Hub
title: "Add Template: [Template Name]"
labels: "add-template"
assignees: ""
---

If you'd like to add a template to man Hub, follow the [Add Template guide](https://dyad.sh/docs/templates/add-template).
